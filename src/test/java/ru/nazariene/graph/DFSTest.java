...
public class DFSTest {
    ...
    public void testUnweightedDirectionalGraph() {
        ...
        DFS dfs = new DFS();
        List<Edge> result = dfs.perform(graph, 0);

        Assert.assertEquals(5, result.size());
        Assert.assertEquals(0, result.get(0).getFrom());
        Assert.assertEquals(2, result.get(0).getTo());
        Assert.assertEquals(2, result.get(1).getFrom());
        Assert.assertEquals(4, result.get(1).getTo());
        Assert.assertEquals(4, result.get(2).getFrom());
        Assert.assertEquals(3, result.get(2).getTo());
        Assert.assertEquals(3, result.get(3).getFrom());
        Assert.assertEquals(5, result.get(3).getTo());
        Assert.assertEquals(0, result.get(4).getFrom());
        Assert.assertEquals(1, result.get(4).getTo());

        result = dfs.perform(graph, 5);
    ...
    public void testUnweightedGraph() {
        ...
        Assert.assertEquals(4, result.get(1).getTo());
        Assert.assertEquals(4, result.get(2).getFrom());
        Assert.assertEquals(5, result.get(2).getTo());
        Assert.assertEquals(5, result.get(3).getFrom());
        Assert.assertEquals(3, result.get(3).getTo());
        ...
        Assert.assertEquals(1, result.get(3).getFrom());
        Assert.assertEquals(2, result.get(3).getTo());
        Assert.assertEquals(2, result.get(4).getFrom());
